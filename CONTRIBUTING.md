...
This document explains the processes and practices recommended for contributing enhancements to the Wazuh Indexer Operator.
...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/wazuh-indexer-operator)
...
Canonical welcomes contributions to the Wazuh Indexer Operator. Please check out our
...
```
git clone https://github.com/canonical/wazuh-indexer-operator
```
...
OCI image for the Wazuh Indexer app, and then upload the image to a MicroK8s registry,
...
# Deploy the charm
juju deploy ./wazuh-indexer*.charm 
```
